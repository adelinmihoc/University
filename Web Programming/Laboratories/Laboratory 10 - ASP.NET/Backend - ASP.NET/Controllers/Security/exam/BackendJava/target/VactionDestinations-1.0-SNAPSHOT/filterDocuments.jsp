...
<%@ page import="java.util.Map"%><%@ page import="model.UsernameDestinationDTO"%>
<%@ page import="model.VacationDestinationDAO"%><%@ page import="model.UsernameDTO"%><%@ page import="model.DocumentDAO"%>
...
<%
    ...
    out.print(DocumentDAO.getAllFiltered(obj.getUsername()).toString());
%>
