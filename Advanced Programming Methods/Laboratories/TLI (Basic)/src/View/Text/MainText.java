...
public class MainText {
    public static void main(String[] args) {
        ...
        //-----------------------------------------//
        IStatement example9 = new PrintStatement(new ConstExpression(new IntValue(10)));
        ...
        //----------ProgramStates----------//
        ProgramState programState1 = new ProgramState(stack1, symTable1,out1,example1,fileTable1, heap1);
        ProgramState programState2 = new ProgramState(stack2, symTable2,out2,example2,fileTable2, heap2);
        ProgramState programState3 = new ProgramState(stack3, symTable3,out3,example3,fileTable3, heap3);
        ProgramState programState4 = new ProgramState(stack4, symTable4,out4,example4,fileTable4, heap4);
        ProgramState programState5 = new ProgramState(stack5, symTable5,out5,example5,fileTable5, heap5);
        ProgramState programState6 = new ProgramState(stack6, symTable6,out6,example6,fileTable6, heap6);
        ProgramState programState7 = new ProgramState(stack7, symTable7,out7,example7,fileTable7, heap7);
        ProgramState programState8 = new ProgramState(stack8, symTable8,out8,example8,fileTable8, heap8);
        ProgramState programState9 = new ProgramState(stack9, symTable9,out9,example9,fileTable9, heap9);
        ProgramState programState10 = new ProgramState(stack10, symTable10,out10,example10,fileTable10, heap10);
