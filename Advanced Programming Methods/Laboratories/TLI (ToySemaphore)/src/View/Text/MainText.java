...
public class MainText {
    public static void main(String[] args) {
        ...
        IStatement example9 = new CompoundStatement(
                ...
                new CompoundStatement(
                        ...
                        new CompoundStatement(
                                ...
                                new CompoundStatement(
                                        new NewSemaphore("cnt", new ReadHeapExpression(new VarExpression("v1")), new ConstExpression(new IntValue(1))),
                                        new CompoundStatement(
        ...
        //----------Semaphore Tables----------//
        ISemaphoreTable<Integer, Triplet<Integer, java.util.List<Integer>, Integer>> semaphoreTable1 = new SemaphoreTable<>();
        ISemaphoreTable<Integer, Triplet<Integer, java.util.List<Integer>, Integer>> semaphoreTable2 = new SemaphoreTable<>();
        ISemaphoreTable<Integer, Triplet<Integer, java.util.List<Integer>, Integer>> semaphoreTable3 = new SemaphoreTable<>();
        ISemaphoreTable<Integer, Triplet<Integer, java.util.List<Integer>, Integer>> semaphoreTable4 = new SemaphoreTable<>();
        ISemaphoreTable<Integer, Triplet<Integer, java.util.List<Integer>, Integer>> semaphoreTable5 = new SemaphoreTable<>();
        ISemaphoreTable<Integer, Triplet<Integer, java.util.List<Integer>, Integer>> semaphoreTable6 = new SemaphoreTable<>();
        ISemaphoreTable<Integer, Triplet<Integer, java.util.List<Integer>, Integer>> semaphoreTable7 = new SemaphoreTable<>();
        ISemaphoreTable<Integer, Triplet<Integer, java.util.List<Integer>, Integer>> semaphoreTable8 = new SemaphoreTable<>();
        ISemaphoreTable<Integer, Triplet<Integer, java.util.List<Integer>, Integer>>semaphoreTable9 = new SemaphoreTable<>();
        ISemaphoreTable<Integer, Triplet<Integer, java.util.List<Integer>, Integer>>semaphoreTable10 = new SemaphoreTable<>();
