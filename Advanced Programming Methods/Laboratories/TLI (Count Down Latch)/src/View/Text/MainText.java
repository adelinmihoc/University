...
public class MainText {
    public static void main(String[] args) {
        ...
        IStatement example9 = new CompoundStatement(
                ...
                new CompoundStatement(
                        new VarDeclStatement("v2", new ReferenceType(new IntType())),
                        new CompoundStatement(
                                new VarDeclStatement("v3", new ReferenceType(new IntType())),
                                new CompoundStatement(
                                        new VarDeclStatement("cnt", new IntType()),
                                        new CompoundStatement(
                                                new HeapAllocationStatement("v1", new ConstExpression(new IntValue(2))),
                                                new CompoundStatement(
                                                        new HeapAllocationStatement("v2", new ConstExpression(new IntValue(3))),
                                                        new CompoundStatement(
                                                                new HeapAllocationStatement("v3", new ConstExpression(new IntValue(4))),
                                                                new CompoundStatement(
                                                                        new NewLatch("cnt", new ReadHeapExpression(new VarExpression("v2"))),
                                                                        new CompoundStatement(
                                                                                new ForkStatement(new CompoundStatement(
                                                                                        ...
                                                                                        new CompoundStatement(
                                                                                                ...
                                                                                                new CompoundStatement(
                                                                                                        new CountDown("cnt"),
                                                                                                        new ForkStatement(new CompoundStatement(
                                                                                                                new HeapWriteStatement("v2", new ArithmeticExpression('*', new ReadHeapExpression(new VarExpression("v2")), new ConstExpression(new IntValue(10)))),
                                                                                                                new CompoundStatement(
                                                                                                                        new PrintStatement(new ReadHeapExpression(new VarExpression("v2"))),
                                                                                                                        new CompoundStatement(
                                                                                                                                new CountDown("cnt"),
                                                                                                                                new ForkStatement(new CompoundStatement(
                                                                                                                                        new HeapWriteStatement("v3", new ArithmeticExpression('*', new ReadHeapExpression(new VarExpression("v3")), new ConstExpression(new IntValue(10)))),
                                                                                                                                        new CompoundStatement(
                                                                                ...
                                                                                new CompoundStatement(
                                                                                        new Await("cnt"),
                                                                                        new CompoundStatement(
                                                                                                new PrintStatement(new ConstExpression(new IntValue(100))),
                                                                                                new CompoundStatement(
                                                                                                        new CountDown("cnt"),
                                                                                                        new PrintStatement(new ConstExpression(new IntValue(100)))
                                                                                                )
        ...
        //----------LatchTables----------//
        ILatchTable<Integer, Value> latchTable1 = new LatchTable<>();
        ILatchTable<Integer, Value> latchTable2 = new LatchTable<>();
        ILatchTable<Integer, Value> latchTable3 = new LatchTable<>();
        ILatchTable<Integer, Value> latchTable4 = new LatchTable<>();
        ILatchTable<Integer, Value> latchTable5 = new LatchTable<>();
        ILatchTable<Integer, Value> latchTable6 = new LatchTable<>();
        ILatchTable<Integer, Value> latchTable7 = new LatchTable<>();
        ILatchTable<Integer, Value> latchTable8 = new LatchTable<>();
        ILatchTable<Integer, Value> latchTable9 = new LatchTable<>();
        ILatchTable<Integer, Value> latchTable10 = new LatchTable<>();


        //----------ProgramStates----------//
        ProgramState programState1 = new ProgramState(stack1, symTable1,out1,example1,fileTable1, heap1, latchTable1);
        ProgramState programState2 = new ProgramState(stack2, symTable2,out2,example2,fileTable2, heap2, latchTable2);
        ProgramState programState3 = new ProgramState(stack3, symTable3,out3,example3,fileTable3, heap3, latchTable3);
        ProgramState programState4 = new ProgramState(stack4, symTable4,out4,example4,fileTable4, heap4, latchTable4);
        ProgramState programState5 = new ProgramState(stack5, symTable5,out5,example5,fileTable5, heap5, latchTable5);
        ProgramState programState6 = new ProgramState(stack6, symTable6,out6,example6,fileTable6, heap6, latchTable6);
        ProgramState programState7 = new ProgramState(stack7, symTable7,out7,example7,fileTable7, heap7, latchTable7);
        ProgramState programState8 = new ProgramState(stack8, symTable8,out8,example8,fileTable8, heap8, latchTable8);
        ProgramState programState9 = new ProgramState(stack9, symTable9,out9,example9,fileTable9, heap9, latchTable9);
        ProgramState programState10 = new ProgramState(stack10, symTable10,out10,example10,fileTable10, heap10, latchTable10);
