...
public class ProgramState {
    ...
    public ProgramState(IStack<IStatement> exeStack, IDict<String, Value> symTable, IList<Value> out,
                        ...
                        IHeap<Integer, Value> heap, ISemaphoreTable<Integer, Pair<Integer, java.util.List<Integer>>> semaphoreTable) {
    ...
    public ProgramState(IStack<IStatement> exeStack, IDict<String, Value> symTable, IList<Value> out,
                        IStatement originalProgram, IDict<StringValue, BufferedReader> fileTable,
                        IHeap<Integer, Value> heap, int id, ISemaphoreTable<Integer, Pair<Integer, java.util.List<Integer>>> semaphoreTable) {
        this.exeStack = exeStack;
        this.symTable = symTable;
        this.out = out;
        this.originalProgram = originalProgram;
    ...
    public ISemaphoreTable<Integer, Pair<Integer, java.util.List<Integer>>> getSemaphoreTable() {
