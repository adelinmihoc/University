...
public class MainText {
    final static IStatement example9;
    static  {
                ...
                new CompoundStatement(
                        ...
                        new CompoundStatement(
                                ...
                                new CompoundStatement(
                                        ...
                                        new CompoundStatement(
                                                new HeapAllocationStatement("v1", new ConstExpression(new IntValue(20))),
                                                new CompoundStatement(
                                                        new HeapAllocationStatement("v2", new ConstExpression(new IntValue(30))),
                                                        new CompoundStatement(
                                                                new NewLock("x"),
                                                                new CompoundStatement(
                                                                        new ForkStatement(
                                                                                                        ...
                                                                                                        new CompoundStatement(
                                                                                                                new HeapWriteStatement(
                                                                                                                        ...
                                                                                                                        new ArithmeticExpression(
                                                                                                                                ...
                                                                                                                                new ConstExpression(new IntValue(1))
                                                                                                                        )
                                                                                                                ),
                                                                                                                new Unlock("x")
                                                                                                        )
                                                                                                ...
                                                                                                new CompoundStatement(
                                                                                                        new HeapWriteStatement(
                                                                                                                ...
                                                                                                                new ArithmeticExpression(
                                                                                                                        '*',
                                                                                                                        new ReadHeapExpression(new VarExpression("v1")),
                                                                                                                        new ConstExpression(new IntValue(10))
                                                                                                                )
                                                                                                        ),
                                                                                                        new Unlock("x")
                                                                                                )
                                                                                                                        ...
                                                                                                                        new CompoundStatement(
                                                                                                                                new HeapWriteStatement(
                                                                                                                                        ...
                                                                                                                                        new ArithmeticExpression(
                                                                                                                                                ...
                                                                                                                                                new ConstExpression(new IntValue(5))
                                                                                                                                        )
                                                                                                                                ),
                                                                                                                                new Unlock("q")
                                                                                                                        )
    ...
    final static IStatement example10;
    static {
                                                                ...
                                                                new CompoundStatement(
                                                                        new ForkStatement(new CompoundStatement(
                                                                                new ForkStatement(new CompoundStatement(
                                                                                        new Lock("x"),
                                                                                        new CompoundStatement(
                                                                                                new HeapWriteStatement("v1", new ArithmeticExpression('-', new ReadHeapExpression(new VarExpression("v1")), new ConstExpression(new IntValue(1)))),
                                                                                                new Unlock("x")
                                                                                        )
                                                                                )),
                                                                                new CompoundStatement(
                                                                                ...
                                                                                new CompoundStatement(
                                                                                        new ForkStatement(new CompoundStatement(
                                                                                                new ForkStatement(new CompoundStatement(
                                                                                                        new Lock("q"),
                                                                                                        new CompoundStatement(
                                                                                                                new HeapWriteStatement("v2", new ArithmeticExpression('+', new ReadHeapExpression(new VarExpression("v2")), new ConstExpression(new IntValue(5)))),
                                                                                                                new Unlock("q")
                                                                                                        )
                                                                                                )),
                                                                                                new CompoundStatement(
    ...
    public static void main(String[] args) {
        ...
        //----------Lock Tables----------//
        ILockTable<Integer> lockTable1 = new LockTable<>();
        ILockTable<Integer> lockTable2 = new LockTable<>();
        ILockTable<Integer> lockTable3 = new LockTable<>();
        ILockTable<Integer> lockTable4 = new LockTable<>();
        ILockTable<Integer> lockTable5 = new LockTable<>();
        ILockTable<Integer> lockTable6 = new LockTable<>();
        ILockTable<Integer> lockTable7 = new LockTable<>();
        ILockTable<Integer> lockTable8 = new LockTable<>();
        ILockTable<Integer> lockTable9 = new LockTable<>();
        ILockTable<Integer> lockTable10 = new LockTable<>();


        //----------ProgramStates----------//
        ProgramState programState1 = new ProgramState(stack1, symTable1,out1,example1,fileTable1, heap1, lockTable1);
        ProgramState programState2 = new ProgramState(stack2, symTable2,out2,example2,fileTable2, heap2, lockTable2);
        ProgramState programState3 = new ProgramState(stack3, symTable3,out3,example3,fileTable3, heap3, lockTable3);
        ProgramState programState4 = new ProgramState(stack4, symTable4,out4,example4,fileTable4, heap4, lockTable4);
        ProgramState programState5 = new ProgramState(stack5, symTable5,out5,example5,fileTable5, heap5, lockTable5);
        ProgramState programState6 = new ProgramState(stack6, symTable6,out6,example6,fileTable6, heap6, lockTable6);
        ProgramState programState7 = new ProgramState(stack7, symTable7,out7,example7,fileTable7, heap7, lockTable7);
        ProgramState programState8 = new ProgramState(stack8, symTable8,out8,example8,fileTable8, heap8, lockTable8);
        ProgramState programState9 = new ProgramState(stack9, symTable9,out9,example9,fileTable9, heap9, lockTable9);
        ProgramState programState10 = new ProgramState(stack10, symTable10,out10,example10,fileTable10, heap10, lockTable10);
