...
void USER_GUI::init_user_gui() {
    ...
    this->myfile_location_edit->setText("lab9/csvfil.csv");
...
void USER_GUI::update_buttons_background() {
    ...
    this->mylist_button->setStyleSheet("background-color:solid white");
}
...
void USER_GUI::next_statue_button_handler() {
    try {
        ...
        QTimer::singleShot(1500, this, SLOT(update_buttons_background()));
    } catch(std::exception&) {
