...
public class OrderService  extends Service<Pair<Integer, Integer>, Order> {
         ...
         */
        public OrderService(Repository<Pair<Integer, Integer>, Order> constructorRepo, Repository<Integer, Coffee> coffeeRepository, Repository<Integer, Client> clientRepository) {
