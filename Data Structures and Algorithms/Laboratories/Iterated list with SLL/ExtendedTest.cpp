...
void testJumpBackward() {
    ...
    list.addToEnd(7);
    list.addToEnd(8);
    ListIterator listIt = list.iterator();
    listIt.next();
    listIt.next();
    listIt.next();
    listIt.next();
    ...
    listIt.next();
    listIt.next();
    assert(listIt.getCurrent() == 7);
    listIt.jumpBackward(3);
    assert(listIt.getCurrent() == 4);
    try {
        listIt.jumpBackward(6);
        assert(false);
    }
    catch (exception(&)) {
        assert(true);
