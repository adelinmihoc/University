...
X = (U < p); % true or false I guess?

%Generate a sample of N such variables

N = input('nr. of simulations = '); %try different numbers 10, 100, 1e4, 1e6
...
% Try diffenret numbers of simulations, loook at the values of U_X and
% rel_freq
fprintf('n_x = %d\n', n_X);
fprintf('rel_freq = %d\n', rel_freq);
