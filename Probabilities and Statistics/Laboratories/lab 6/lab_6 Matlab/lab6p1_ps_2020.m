...
[h, p, ci, zstat] = ztest(x, m0, sigma, alpha, -1); % -1 is for left-tailed, 1 for right,
...
% the alt. hypothesis H1: mu > 5.5. This is a right-tailed test for mu.
...
[h, p, ci, stats] = ttest(x, m0b, alpha, 1); % 1, for right-tailed
