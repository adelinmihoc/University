...
class SimpleNet(nn.Module):
    ...
    def forward(self, input):
        output = self.net(input)  # [32, 128, 7, 7]
        # print(output.shape)
...
image_list, image_classes = classifier.get_image_list_and_classes("../train_images")
print("---finished")
train_set = classifier.ImageClassifierDataset(image_list, image_classes)
# Create a loader for the training set
train_loader = DataLoader(train_set, batch_size=batch_size, shuffle=True, num_workers=0)

# test
print("---loading test images")
image_list, image_classes = classifier.get_image_list_and_classes("../test_images")
print("---finished")
...
def test():
    ...
    # Compute the average acc and loss over all 90 test images
